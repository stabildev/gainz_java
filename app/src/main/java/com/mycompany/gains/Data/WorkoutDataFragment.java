...
package com.mycompany.gains.Data;
...
public class WorkoutDataFragment extends Fragment {
    private Workout mWorkout;

    public static WorkoutDataFragment newInstance(Workout workout) {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setRetainInstance(true);  // keep the mWorkout instance
    }
